...
33:
	...
	%37 = load i32, i32* %36
	%38 = call i8* @toString(i32 %37)
	%39 = bitcast [2 x i8]* @.str.0 to i8*
	%40 = call i8* @string_add(i8* %38, i8* %39)
...
41:
	...
	br label %28
44:
	%45 = bitcast [1 x i8]* @.str.1 to i8*
	call void @println(i8* %45)
	%46 = load i32*, i32** %12
	call void @bubble_sort(i32* %46)
	store i32 0, i32* %13
	br label %47
47:
	%48 = load i32, i32* %13
...
52:
	...
	%56 = load i32, i32* %55
	%57 = call i8* @toString(i32 %56)
	%58 = bitcast [2 x i8]* @.str.2 to i8*
	%59 = call i8* @string_add(i8* %57, i8* %58)
	call void @print(i8* %59)
	br label %60
60:
	%61 = load i32, i32* %13
	%62 = add i32 %61, 1
